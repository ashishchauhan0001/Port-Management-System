...
int check()
{
    ...
    do
    {
        ...
        {
            cout << "You have entered a wrong input.Please enter a correct one" << endl;
        }
        count++;
    } while (count != 3);
    if (count == 3)
...
// foloowing functions are to print the details of team members and about the topic
...
Ship *takeToShip(Ship *root, int x)
{
    Ship *temp = root;
    while (temp != NULL)
    {
        ...
        case 'C':
            ...
            while (n != 4)
            {
                ...
                case 2:
                {
                    ...
                    cin >> id;
                    Ship *myShip = takeToShip(root, id);
                    cout << "Details of ship with id " << id << " are : " << endl;
                ...
                case 3:
                {
                    ...
                    while (numrent > numleft)
                    {
                        ...
                        if (numrent > numleft)
                        {
                            ...
                            cout << endl;
                            cout << "Please enter a number lower than the no. of ships available : ";
                            cout << endl;
                        }
                    }
                }
